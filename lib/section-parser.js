 ...
 */
module.exports.sections = function(css) {
 ...
 * @return {String}
 */
module.exports.sanitize = function(content) {
 ...
 * @return {String}
 */
module.exports.stripComments = function(css, replacement) {
 ...
 * @return {Range}
 */
module.exports.matchBracesRanges = function(content, pos, sanitize) {
	if (sanitize) {
 ...
 * @return {Range}
 */
module.exports.extractSelector = function(content, pos, sanitize) {
	if (sanitize) {
		content = this.sanitize(content);
	}
